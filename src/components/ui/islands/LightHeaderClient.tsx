...
export default function LightHeaderClient() {
    ...
    >
      <nav className="flex justify-between items-center w-full px-8 max-w-[1200px] mx-auto relative z-[1001]">
          ...
          <div className="flex items-center">
            <a href="/">
              <img
                ...
                className="h-20 w-auto transition-all duration-300 invert"
              />
            </a>
          </div>
          <div className="w-[3px] h-6 bg-gray-800/30 hidden md:block"></div>
          <ul className="hidden md:flex list-none gap-8">
            <li>
              <a
                href="/"
                className="text-gray-900 !font-normal relative inline-block group"
              >
                Home
        ...
        <div className="flex items-center gap-4">
          <a href="tel:+18014770418" className="inline-flex items-center justify-center bg-gray-900 text-white py-3 px-6 rounded-full font-heading font-normal text-sm hover:bg-gray-800 transition-colors !hidden md:!flex">
            (801) 477-0418
          </a>
          <button
          ...
          >
            <div 
              className={`h-0.5 w-6 rounded-full transition-all duration-500 absolute bg-gray-900 ${
            ...
            ></div>
            <div 
              className={`h-0.5 rounded-full transition-all duration-500 absolute bg-gray-900 ${
